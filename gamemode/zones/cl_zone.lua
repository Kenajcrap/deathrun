...
function ZONE:DrawCuboid( pos1, pos2, col, alt )
	...
	if alt == 2 then
		...
		render.DrawQuad( points[1], points[2], points[3], points[4], Color(col.r,col.g,col.b,(col.a^3)/255^2))
		render.DrawQuad( points[8], points[7], points[6], points[5], Color(col.r,col.g,col.b,(col.a^3)/255^2))
		render.DrawQuad( points[6], points[2], points[1], points[5], Color(col.r,col.g,col.b,(col.a^3)/255^2))
		render.DrawQuad( points[8], points[4], points[3], points[7], Color(col.r,col.g,col.b,(col.a^3)/255^2))
		render.DrawQuad( points[4], points[8], points[5], points[1], Color(col.r,col.g,col.b,(col.a^3)/255^2))
